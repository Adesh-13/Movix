...
const CarouselWithoutRating  = ({data, loading, endpt,title}) => {
            ...
            (
                <div className="carouselItems" ref={carouselContainer}>
                    {data?.map((item) => {
                        ...
                        return (
                            <div key={item.id} className="carouselItem" onClick={()=> navigate(`/movie/${item.id}`)}>
...
export default CarouselWithoutRating